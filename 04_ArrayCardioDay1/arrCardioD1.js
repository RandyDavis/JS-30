...
// Old way
// const orderedBirthdates = inventors.sort((a, b) => {
//     if (a.year > b.year) {
//       return 1;
//     } else {
//       return -1;
...
// In One Line!
const orderedBirthdates = inventors.sort((a, b) => a.year > b.year ? 1 : -1);
console.table(orderedBirthdates);
...
// 6. create a list of Boulevards in Paris that contain 'de' anywhere in the name (use below link as data source)
// https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris
// const category = document.querySelector('.mw-category');
// // -- Need to change NodeList into an array -- Can be done 2 ways:
// // 1:
// const links = Array.from(category.querySelectorAll('a'));
// // OR 2 using es6 spread:
